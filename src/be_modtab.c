/********************************************************************
** Berry module table for BLEberry.
**
** Adapted from berry/default/be_modtab.c (see the Berry LICENSE).
** Only the modules enabled in berry_conf.h end up in the table.
********************************************************************/
#include "berry.h"
